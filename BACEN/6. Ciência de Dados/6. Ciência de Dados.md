...
- Uso de Machine Learning p/ processar e interpretar texto e dados.
...
- Chatbots **baseados em IA (Não Lineares):**
  ...
  - Utilizam _algoritmos de Machine Learning e de PLN_ p/ entender e responder às perguntas dos usuários.
...
Obs.: Machine Learning envolve também Agrupamento de Documentos (Document Clustering) e Classificação de Documentos.
