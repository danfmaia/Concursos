...
2. Aprendizado de Máquina - Introdução
...
## 6.1. Aprendizado de Máquina (AM) - Introdução
...
- Underfitting
  ...
  > Def. — A hipótese induzida aprensenta um desempenho ruim tanto no conjunto de treinamento como de teste.
